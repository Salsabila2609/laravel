<template>
  <div>
    ...
    <div class="text-sm text-[#99CBC0] font-bold py-4 px-6" style="margin-left: 75px;">
      <Link href="/" class="text-[#D4A017] no-underline">Beranda</Link> > Laporan Keuangan 2023
    </div>

    <div class="relative z-10 px-5 py-10 text-gray-800">
      <h1 class="text-4xl font-bold text-center text-[#D4A017] mt-12">LAPORAN KEUANGAN 2023</h1>
      <p class="text-xl text-center text-white mb-12 max-w-[85%] mx-auto">
        Berikut adalah daftar laporan keuangan 2023 yang tersedia untuk diunduh.
      </p>
...
export default {
  ...
  computed: {
    ...
    filteredDocuments() {
      return this.documents.filter(doc => doc.category === "Laporan Keuangan 2023");
    },
  },
};
</script>
